...
func (s *Extension) Init(app *nibbler.Application) error {
	if s.CredentialsPath == "" {
		s.CredentialsPath = app.Config.Raw.Get("google.drive.credentials.path").String("drive-credentials.json")
	}

	if s.TokenFilePath == "" {
		s.TokenFilePath = app.Config.Raw.Get("google.drive.tokenfile.path").String("drive-token.json")
	}
